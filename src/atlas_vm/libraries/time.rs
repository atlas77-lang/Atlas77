...
//now() -> &Time
pub fn now<'lib>(state: VMState) -> Result<VMData<'lib>, RuntimeError> {
...
pub fn format_time_iso<'lib>(state: VMState) -> Result<VMData<'lib>, RuntimeError> {
...
pub fn format_time<'lib>(state: VMState) -> Result<VMData<'lib>, RuntimeError> {
...
pub fn elapsed<'lib>(state: VMState) -> Result<VMData<'lib>, RuntimeError> {
